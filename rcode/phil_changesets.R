...
hist(log(changesetInfo$area, base=10), col='purple', main="Frequency of Area Size (Sq. km)", xlab="Log_10 Changeset Count", ylab="Freq")
hist(changesetInfo$created_at, breaks='day', col='orange', main="Times of Edits", xlab="When", ylab="Changesets")
